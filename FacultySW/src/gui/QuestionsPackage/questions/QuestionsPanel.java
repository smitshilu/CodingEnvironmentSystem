...
import gui.QuestionsPackage.newquestion.NewQuestionFrame;
...
import database.load.LoadQuestions;

@SuppressWarnings("serial")
public class QuestionsPanel extends JPanel implements ListSelectionListener,
		NewQuestionAddedListener {
	...
	currentQuestion cq = new currentQuestion();
	ToolsPanel submitpane;

	public QuestionsPanel(String contestname) {
	...
	private void setUpPanel() {
		...
		JButton backBtn = new JButton("Add Question", new ImageIcon(
				QuestionsPanel.class.getResource("/img/addicon.png")));
		...
		backBtn.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				NewQuestionFrame qf = new NewQuestionFrame(contestname,
						QuestionsPanel.this);
				qf.setVisible(true);
			}
		});
		...
		if (!questions.isEmpty()) {
			...
			cq.setCurrentQ(tempq.getQ_name());
			cq.setQuestions(tempq.getQ_qstn());
			cq.setInputs(tempq.getQ_ip());
			cq.setOutputs(tempq.getQ_op());
			cq.setConstraints(tempq.getQ_cons());
			cq.setExamples(tempq.getQ_ex());
			cq.setTest_inputs(tempq.getTest_ip());
			cq.setTest_outputs(tempq.getTest_op());
			cq.setCp(QuestionsPanel.this);

			qustn_detail
					.append("<html><font size=\"5\"><b>Question code: </b></font><br>"
							+ tempq.getQ_name() + "<br><br>");
			qustn_detail.append("<font size=\"5\"><b>Question: </b></font><br>"
					+ tempq.getQ_qstn().replace("\n", "<br>") + "<br><br>");
			qustn_detail
					.append("<font size=\"5\"><b>Sample Input: </b></font><br>"
							+ tempq.getQ_ip().replace("\n", "<br>")
							+ "<br><br>");
			qustn_detail
					.append("<font size=\"5\"><b>Sample Output: </b></font><br>"
							+ tempq.getQ_op().replace("\n", "<br>")
							+ "<br><br>");
			qustn_detail
					.append("<font size=\"5\"><b>Constraints: </b></font><br>"
							+ tempq.getQ_cons().replace("\n", "<br>")
							+ "<br><br>");
			qustn_detail.append("<font size=\"5\"><b>Example: </b></font><br>"
					+ tempq.getQ_ex().replace("\n", "<br>") + "<br><br>");
			qustn_detail
					.append("<font size=\"5\"><b>Test Input: </b></font><br>"
							+ tempq.getTest_ip().replace("\n", "<br>")
							+ "<br><br>");
			qustn_detail
					.append("<font size=\"5\"><b>Test Output: </b></font><br>"
							+ tempq.getTest_op().replace("\n", "<br>")
							+ "<br><br></html>");
			...
			submitpane = new ToolsPanel(contestname, cq);
	...
	public void valueChanged(ListSelectionEvent arg0) {
		if (!arg0.getValueIsAdjusting()) {
			...
			refreshRightComponent(list.getSelectedIndex());
	...
	private void refreshRightComponent(int index) {
		...
		cq.setTest_outputs(tempq.getTest_op());
		cq.setCp(QuestionsPanel.this);
		submitpane.reloadCQ(cq);
		qustn_detail
				.append("<html><font size=\"5\"><b>Question code: </b></font><br>"
						+ tempq.getQ_name() + "<br><br>");
		qustn_detail.append("<font size=\"5\"><b>Question: </b></font><br>"
				+ tempq.getQ_qstn().replace("\n", "<br>") + "<br><br>");
		qustn_detail.append("<font size=\"5\"><b>Sample Input: </b></font><br>"
				+ tempq.getQ_ip().replace("\n", "<br>") + "<br><br>");
		qustn_detail
				.append("<font size=\"5\"><b>Sample Output: </b></font><br>"
						+ tempq.getQ_op().replace("\n", "<br>") + "<br><br>");
		qustn_detail.append("<font size=\"5\"><b>Constraints: </b></font><br>"
				+ tempq.getQ_cons().replace("\n", "<br>") + "<br><br>");
		qustn_detail.append("<font size=\"5\"><b>Example: </b></font><br>"
				+ tempq.getQ_ex().replace("\n", "<br>") + "<br><br>");
		qustn_detail.append("<font size=\"5\"><b>Test Input: </b></font><br>"
				+ tempq.getTest_ip().replace("\n", "<br>") + "<br><br>");
		qustn_detail.append("<font size=\"5\"><b>Test Output: </b></font><br>"
				+ tempq.getTest_op().replace("\n", "<br>") + "<br><br></html>");
