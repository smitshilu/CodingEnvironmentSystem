...
import database.edit.EditQuestion;
...
public class EditQuestionPanel extends JPanel {
	...
	QuestionsPanel cp;
	String oldproblemcode, question, constraints, inputs, outputs, examples,
			test_input, test_output;

	public EditQuestionPanel(String contestname, QuestionsPanel cp,
		...
		this.oldproblemcode = oldproblemcode;
	...
	JPanel card1() {
		...
		c_name1.setText(oldproblemcode);
		...
		JButton button_create = new JButton("Next", new ImageIcon(
				EditQuestionPanel.class.getResource("/img/go.png")));
	...
	JPanel card5() {
		...
		JButton button_create = new JButton("Edit", new ImageIcon(
				EditQuestionPanel.class.getResource("/img/go.png")));
		button_create.setVerticalTextPosition(SwingConstants.BOTTOM);
		button_create.setHorizontalTextPosition(SwingConstants.CENTER);
		button_create.setFont(new Font("SanSerif", Font.BOLD, 15));
		...
		button_create.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					new EditQuestion(contestname, oldproblemcode, c_name1
							.getText(), c_name2.getText(), c_name3.getText(),
							c_name4.getText(), c_name5.getText(), c_name6
									.getText(), c_name7.getText(), c_name8
									.getText());
					new RenameQuestionDir(contestname, oldproblemcode, c_name1
							.getText());
					JFrame topFrame = (JFrame) SwingUtilities
							.getWindowAncestor(EditQuestionPanel.this);
					topFrame.dispose();
					EditQuestionPanel.this.register(cp);
				} catch (Exception e1) {
					e1.printStackTrace();
					JOptionPane.showMessageDialog(null,
							"Failed to edit the question.");
				}
