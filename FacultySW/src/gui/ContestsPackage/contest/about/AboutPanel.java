...
public class AboutPanel extends JPanel {
	...
	void setUpPanel() {
		...
		JLabel website_link = new JLabel(
				"<html>Visit: <a href='ces.smitshilu.in' style='color:#aaaaaa'>ces.smitshilu.in</a></html>");
		...
		JLabel dev1 = new JLabel(
				"<html>CHINTAN <br>TRIVEDI<br>  11CE117</html>",
				new ImageIcon(AboutPanel.class.getResource("/img/Chintan.png")),
				SwingConstants.LEFT);
		dev1.setForeground(Color.decode("#aaaaaa"));
		madeby.add(dev1);

		JLabel dev2 = new JLabel("<html>SMIT SHILU<br>  11CE109</html>",
				new ImageIcon(AboutPanel.class.getResource("/img/Smit.png")),
				SwingConstants.LEFT);
