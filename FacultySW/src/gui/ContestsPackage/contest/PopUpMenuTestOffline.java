...
class PopUpMenuTestOffline extends JPopupMenu implements ActionListener {
	JMenuItem Item1, Item2, Item3, Item4;
	String contestname;
	GridLayoutContests cp;

	public PopUpMenuTestOffline(String contestname, GridLayoutContests cp) {
		this.cp = cp;
		...
		Item4 = new JMenuItem("Enable Practice Mode", new ImageIcon(
				PopUpMenuTestOffline.class.getResource("/img/practicetype_small.png")));
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		if (event.equals("Put Online")) {
			...
			PopUpMenuTestOffline.this.register(cp);
