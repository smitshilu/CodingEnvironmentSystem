...
public class AllQuestionsPanel extends JPanel implements ListSelectionListener {
	...
	public AllQuestionsPanel(String username, String contestname) {
		this.username = username;
		questions = new ArrayList<Question>();
		listdata = new ArrayList<String>();
		currentLayout = new SpringLayout();
		LoadQuestions lq = new LoadQuestions(contestname, username);
	...
	private void setUpPanel() {
		...
		JButton backBtn = new JButton("Back to Contests", new ImageIcon(
				AllQuestionsPanel.class.getResource("/img/backicon_small.png")));
		...
		backBtn.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				JFrame topFrame = (JFrame) SwingUtilities
						.getWindowAncestor(AllQuestionsPanel.this);
				topFrame.dispose();
			}
		});
		...
		if (!questions.isEmpty()) {
			...
			qustn_detail
					.append("<font size=\"5\"><b>Constraints: </b></font><br>"
							...
							+ "<br><br>");
			qustn_detail
					.append("<font size=\"5\"><b>Explanation: </b></font><br>"
			...
			ToolsPanel submitpane = new ToolsPanel(
					SettingsHash.getSetting("Host"), username, contestname);
	...
	private void refreshRightComponent(int index) {
		...
		qustn_detail.append("<font size=\"5\"><b>Constraints: </b></font><br>"
				+ tempq.getQ_cons().replace("\n", "<br>") + "<br><br>");
		qustn_detail.append("<font size=\"5\"><b>Explanation: </b></font><br>"
				+ tempq.getQ_ex().replace("\n", "<br>") + "<br><br></html>");
