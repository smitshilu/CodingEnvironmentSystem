...
public class AllQuestionsFrame extends JFrame implements ActionListener {

	public AllQuestionsFrame(String username, String contestname) {

		setUpFrame(username, contestname);
	}

	private void setUpFrame(String username, String contestname) {

		this.setIconImage(Toolkit.getDefaultToolkit().getImage(
				AllQuestionsFrame.class.getResource("/img/code.png")));
		...
		setContentPane(new AllQuestionsPanel(username, contestname));
